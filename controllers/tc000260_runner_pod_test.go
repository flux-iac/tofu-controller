...
func Test_000260_runner_pod_test_env_vars_proxy(t *testing.T) {
	...
	g.Expect(spec.Containers[0].Env[6].Name == helloWorldTF.Spec.RunnerPodTemplate.Spec.Env[0].Name)
	g.Expect(spec.Containers[0].Env[6].Value == helloWorldTF.Spec.RunnerPodTemplate.Spec.Env[0].Value)
	g.Expect(spec.Containers[0].Env[7].Name == helloWorldTF.Spec.RunnerPodTemplate.Spec.Env[1].Name)
	g.Expect(spec.Containers[0].Env[7].Value == helloWorldTF.Spec.RunnerPodTemplate.Spec.Env[1].Value)
