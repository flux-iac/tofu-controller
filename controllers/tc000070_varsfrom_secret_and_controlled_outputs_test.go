...
func Test_000070_varsfrom_secret_and_controlled_outputs_test(t *testing.T) {
	const (
		sourceName    = "tf-vars-from-controlled-output"
		terraformName = "helloworld-vars-from-controlled-output"
	)
	g := NewWithT(t)
