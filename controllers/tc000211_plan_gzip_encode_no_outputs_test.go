...
func Test_000211_plan_gzip_encode_no_outputs_test(t *testing.T) {
	Spec("This spec describes the behaviour of a Terraform resource having gzip encoding annotation, with no backend, and `auto` approve.")
