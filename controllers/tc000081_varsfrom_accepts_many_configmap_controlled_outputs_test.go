...
func Test_000081_varsfrom_accepts_many_configMaps(t *testing.T) {
	...
	By("checking that the TF output configMap contains a binary data")
	...
	By("checking that the TF output secret contains the correct output provisioned by the TF hello world")
	// Value is a JSON representation of TF's OutputMeta
	expectedOutputValue := map[string]string{
		"Name":        "tf-output-" + terraformName,
		"Namespace":   "flux-system",
		"Value":       "Hello, config-2-value!",
