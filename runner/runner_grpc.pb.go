...
type RunnerClient interface {
	...
	PreInit(ctx context.Context, in *PreInitRequest, opts ...grpc.CallOption) (*PreInitReply, error)
...
func (c *runnerClient) PreInit(ctx context.Context, in *PreInitRequest, opts ...grpc.CallOption) (*PreInitReply, error) {
	out := new(PreInitReply)
	err := c.cc.Invoke(ctx, "/runner.Runner/PreInit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RunnerServer interface {
	...
	PreInit(context.Context, *PreInitRequest) (*PreInitReply, error)
...
func (UnimplementedRunnerServer) PreInit(context.Context, *PreInitRequest) (*PreInitReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PreInit not implemented")
}
...
func _Runner_PreInit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PreInitRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RunnerServer).PreInit(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/runner.Runner/PreInit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RunnerServer).PreInit(ctx, req.(*PreInitRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Runner_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PreInit",
			Handler:    _Runner_PreInit_Handler,
		},
		{
