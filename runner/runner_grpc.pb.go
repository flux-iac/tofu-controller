...
type RunnerClient interface {
	...
	Validate(ctx context.Context, in *ValidationRequest, opts ...grpc.CallOption) (*ValidationReply, error)
...
func (c *runnerClient) Validate(ctx context.Context, in *ValidationRequest, opts ...grpc.CallOption) (*ValidationReply, error) {
	out := new(ValidationReply)
	err := c.cc.Invoke(ctx, "/runner.Runner/Validate", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RunnerServer interface {
	...
	Validate(context.Context, *ValidationRequest) (*ValidationReply, error)
...
func (UnimplementedRunnerServer) Validate(context.Context, *ValidationRequest) (*ValidationReply, error) {
...
func _Runner_Validate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RunnerServer).Validate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/runner.Runner/Validate",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RunnerServer).Validate(ctx, req.(*ValidationRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Runner_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Validate",
			Handler:    _Runner_Validate_Handler,
		},
		{
			MethodName: "Plan",
