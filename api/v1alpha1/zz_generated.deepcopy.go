...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TerraformStatusSpec) DeepCopyInto(out *TerraformStatusSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TerraformStatusSpec.
func (in *TerraformStatusSpec) DeepCopy() *TerraformStatusSpec {
	if in == nil {
		return nil
	}
	out := new(TerraformStatusSpec)
