...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *LocalObjectNameRef) DeepCopyInto(out *LocalObjectNameRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new LocalObjectNameRef.
func (in *LocalObjectNameRef) DeepCopy() *LocalObjectNameRef {
	if in == nil {
		return nil
	}
	out := new(LocalObjectNameRef)
	in.DeepCopyInto(out)
	return out
}
