...
For a full list of features and how to use them, please follow the [Use Tofu Controller](use-tf-controller/index.md) guide.

## Other Examples
  * A Terraform GitOps with Flux to automatically reconcile your [AWS IAM Policies](https://github.com/flux-iac/aws-iam-policies).
  * GitOps an existing EKS cluster, by partially import its nodegroup and manage it with Tofu Controller: [An EKS scaling example](https://github.com/flux-iac/eks-scaling).
