...
| branchBasedPlanner | object | `{"enabled":false,"image":{"repository":"ghcr.io/weaveworks/branch-based-planner","tag":"latest"},"replicaCount":1}` | Branch Based Planner-specific configurations |
