...
![Version: 0.16.0-dev](https://img.shields.io/badge/Version-0.16.0--dev-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: v0.16.0-dev](https://img.shields.io/badge/AppVersion-v0.16.0--dev-informational?style=flat-square)
...
| branchPlanner | object | `{"enabled":false,"image":{"pullPolicy":"IfNotPresent","repository":"ghcr.io/weaveworks/branch-planner","tag":""}}` | Branch Planner-specific configurations |
...
| runner | object | `{"creationTimeout":"5m0s","grpc":{"maxMessageSize":4},"image":{"repository":"ghcr.io/weaveworks/tf-runner","tag":"v0.16.0-dev"},"serviceAccount":{"allowedNamespaces":[],"annotations":{},"create":true,"name":""}}` | Runner-specific configurations |
